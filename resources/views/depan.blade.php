@php
 ...
 $instagram = get_setting_value('_intagram');
 $tweeter = get_setting_value('_twiter');
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 mb-5 mb-lg-0">
            ...
            @endif
            @if ($tweeter)
                <a class="btn btn-outline-light btn-social mx-1" href="{{$tweeter}}" target="blank"><i class="fab fa-fw fa-twitter"></i></a>
            @endif
            @if ($facebook)
